...
# ============================================================
# FUNGSI LOAD DATA - TANPA FILTER OUTLIER
# ============================================================
def load_data():
    df = pd.read_excel(DATA_PATH)
    data = df[FEATURE_COLS].values
    
    print(f"✅ Data dimuat: {len(data)} baris (dataset FULL, tanpa filter outlier)")
    return data, df
...
def main():
    print("=" * 60)
    print("TRAINING LSTM MULTI-TARGET DENGAN OPTUNA")
    print("=" * 60)
    print(f"Dataset: FULL (tanpa filter outlier)")
